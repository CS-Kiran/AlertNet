...
const words = ["Safety", "AlertNet", "Unity"];

const colors = {
  Safety: "bg-gradient-to-r from-purple-500 to-purple-700",
  AlertNet: "bg-gradient-to-r from-yellow-500 to-orange-500",
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-800 leading-tight mb-6">
            Empowering{" "}
            <span
              className={`text-transparent ${colors[currentWord]} bg-clip-text whitespace-nowrap`}
            >
              {displayedText}
            </span>{" "}<br />
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-700 mb-8 leading-relaxed">
            AlertNet bridges the gap between law enforcement and the public,
            enabling real-time alerts and easy reporting. Stay informed, connect
            seamlessly, and play a vital role in ensuring public safety.
          </p>
        </div>
